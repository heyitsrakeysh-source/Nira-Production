      ...
      {!condensed ? (
        <div className="mb-2.5 flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="inline-flex h-7 items-center gap-1.5 rounded-md border border-line bg-surface px-2.5 text-[12.5px] font-medium text-ink-3 transition-colors hover:text-ink"
          >
        ...
        <table className="w-full border-collapse text-[12.5px]">
          ...
          <thead>
            <tr className="bg-surface-2">
              <th
                scope="col"
                className="sticky left-0 z-20 min-w-[228px] border-b border-line bg-surface-2 px-3 py-2.5 text-left text-[11.5px] font-semibold tracking-wide text-ink-3 "
              >
                Particular
              </th>
              {months.map((m) => (
                <Fragment key={m.key}>
                  <th
                    scope="col"
                    className={cn(
                      "min-w-[112px] border-b border-line px-3 py-2.5 text-right text-[11.5px] font-semibold tracking-wide ",
                    ...
                    <span className="flex items-center justify-end gap-1.5">
                      ...
                      {onEditMonth ? (
                        <button
                          ...
                          className="grid size-6 place-items-center rounded text-ink-4 transition-colors hover:bg-surface-3 hover:text-brand"
                        >
                          <Pencil size={11} />
                        </button>
                      ) : null}
                  ...
                  {showDelta ? (
                    <th scope="col" className="min-w-[70px] border-b border-line px-2 py-2.5 text-right text-[11.5px] font-semibold tracking-wide text-ink-4 ">
                      Δ
                    </th>
                  ) : null}
                </Fragment>
              ))}
              <th scope="col" className="min-w-[118px] border-b border-line px-3 py-2.5 text-right text-[11.5px] font-semibold tracking-wide text-ink-3 ">
                Total
              </th>
              <th scope="col" className="min-w-[86px] border-b border-line px-3 py-2.5 text-right text-[11.5px] font-semibold tracking-wide text-ink-3 ">
                % of rev
              </th>
            </tr>
          </thead>
                    ...
                    <span className="flex items-center gap-1.5" style={{ paddingLeft: depth * 14 }}>
                      {isGroup ? (
                        <button
                          ...
                          className="-m-1 grid size-6 shrink-0 place-items-center rounded p-1 text-ink-4 transition-colors hover:bg-surface-3 hover:text-ink"
                        >
                      ...
                      {comments > 0 ? (
                        <span
                          className="ml-1 inline-flex items-center gap-0.5 rounded-full bg-brand-soft px-1.5 py-px text-[11.5px] font-bold text-brand-ink"
                  ...
                  {months.map((m, mi) => {
                    ...
                    return (
                      <Fragment key={m.key}>
                        ...
                        {showDelta ? (
                          <td className="border-b border-line-soft px-2 py-[7px] text-right text-[11.5px] whitespace-nowrap">
              ...
              <>
                <tr>
                  <th
                    scope="row"
                    colSpan={1}
                    className="sticky left-0 z-10 bg-surface px-3 pt-4 pb-1.5 text-left text-[11.5px] font-semibold tracking-wider text-ink-4 "
                  >
                    Memo
                  </th>
                    ...
                    {months.map((m, mi) => {
                      ...
                      return (
                        <Fragment key={m.key}>
                          ...
                          {showDelta ? (
                            <td className="border-b border-line-soft px-2 py-[7px] text-right text-[11.5px]">
                              {prev !== null ? (
