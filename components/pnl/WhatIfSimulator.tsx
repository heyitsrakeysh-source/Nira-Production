  ...
  return (
    <div>
        ...
        {LEVERS.map((l) => {
          ...
          return (
            <div key={l.id}>
              ...
              <div className="mt-1 flex justify-between text-[11.5px] text-ink-4">
                <span>−25%</span>
            ...
            return (
              <div key={r.k} className="flex items-baseline justify-between gap-3">
                ...
                <dd className="flex items-baseline gap-2">
                  <span className="tnum text-[13.5px] font-bold text-ink">{r.fmt(r.value)}</span>
                  {Math.abs(diff) > 0.005 ? (
                    <span
                      className={cn(
                    ...
                    <span className="text-[11.5px] text-ink-4">vs actual</span>
                  )}
                </dd>
              </div>
            );
      ...
      <div className="mt-4 rounded-lg border border-line bg-brand-soft p-3.5">
        <p className="flex items-center gap-1.5 text-[12.5px] font-semibold text-brand-ink">
          <Zap size={13} />
        ...
        <p className="mt-2 text-[11.5px] leading-snug text-brand-ink/80">
