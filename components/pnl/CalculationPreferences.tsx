                ...
                {group.items.map((p, i) => (
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <p className="text-[13.5px] font-medium text-ink">{p.label}</p>
                      <p className="mt-1 text-[12.5px] leading-relaxed text-ink-3">{p.body}</p>
                      {p.impact && state[p.id] ? (
                        <p className="mt-1.5 inline-flex items-center gap-1.5 rounded-md bg-brand-soft px-2 py-1 text-[11.5px] font-medium text-brand-ink">
                          <Info size={11} />
                          {p.impact}
                        </p>
                      ) : null}
