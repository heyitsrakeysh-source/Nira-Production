      ...
      <table className="w-full min-w-[640px] border-collapse text-[12.5px]">
        ...
        <thead className="bg-surface-2">
          <tr>
            ...
            <th scope="col" className="border-b border-line px-3 py-2.5 text-right text-[11.5px] font-semibold tracking-wide text-brand-ink ">
              {currentLabel}
            </th>
            ...
            <th scope="col" className="w-[130px] border-b border-line px-3 py-2.5 text-left text-[11.5px] font-semibold tracking-wide text-ink-3 ">
              Movement
            </th>
          </tr>
        </thead>
              ...
              <tr key={def.id} className="group transition-colors hover:bg-surface-2">
                <th scope="row" className="border-b border-line-soft px-3 py-2 text-left font-medium text-ink">
                  <span className="flex items-center gap-2">
                    ...
                    {def.term ? termLabel(def.term, plainMode) : def.label}
                  </span>
                </th>
                ...
                <td className="border-b border-line-soft px-3 py-2">
                  {def.kind !== "money" ? (
                    <span className="text-[11.5px] text-ink-4">{def.kind}</span>
                  ) : (
