    ...
    <div ref={ref} className="relative w-full" style={{ height }}>
      {width > 0 ? (
        <svg width={width} height={height} role="img" aria-label="Cumulative net profit month to date with projection to month end">
          ...
          <text x={width - M.right + 6} y={y(0)} dominantBaseline="middle" fontSize={11} fill="var(--ink-4)">
            break-even
          </text>
          ...
          />
          <text x={x(today)} y={M.top - 5} textAnchor="middle" fontSize={11} fontWeight={700} fill="var(--ink-3)">
            Today
          </text>
