  ...
  return (
    <div>
      <div className="mb-1.5 flex items-center gap-3">
        ...
        <span className="label-xs flex-1 text-[11.5px]">Share of every ₹100 of revenue</span>
        <span className="label-xs w-[62px] shrink-0 text-right text-[11.5px]">Margin</span>
      </div>
      ...
      <div className="mt-4 flex items-center gap-2.5 border-b border-line pb-1.5">
        ...
        <span className="label-xs flex-1 text-[11.5px]">Where it went</span>
        <span className="label-xs shrink-0 text-[11.5px]">{current.label}</span>
        <span className="label-xs w-[52px] shrink-0 text-right text-[11.5px]">% of rev</span>
        <span className="label-xs w-[62px] shrink-0 text-right text-[11.5px]">vs {comparison.shortLabel}</span>
      </div>
      <ul className="divide-y divide-line-soft">
          ...
          .map((s) => {
            ...
            return (
              ...
              >
                ...
                <span className="tnum w-[52px] shrink-0 text-right text-[12.5px] text-ink-3">{pct(s.share)}</span>
                <span
                  className={cn(
        ...
        <li className="flex items-center gap-2.5 border-t-2 border-line pt-2.5 pb-1">
          ...
          <span className="tnum w-[52px] shrink-0 text-right text-[12.5px] font-semibold text-ink-2">
