    ...
    <div ref={ref} className="relative w-full" style={{ height }}>
      {width > 0 ? (
        <svg width={width} height={height} role="img" aria-label="Flow of revenue into cost categories">
          ...
          {outNodes.map((n, i) => {
            ...
            return (
              ...
              >
                ...
                <text x={labelX} y={ly + 11} fontSize={11.5} fill="var(--ink-3)" className="tnum">
          ...
          <text x={colGross} y={PAD.top - 5} fontSize={11.5} fill="var(--ink-3)" className="tnum">
          ...
          <text x={colNet} y={PAD.top - 5} fontSize={11.5} fill="var(--ink-3)" className="tnum">
            {moneyCompact(month.totalRevenue)}
          </text>

          <text x={colNet + NODE_W + 8} y={PAD.top + netH + 13} fontSize={11.5} fontWeight={600} fill="var(--critical-ink)">
            Returns &amp; discounts
          </text>
          <text x={colNet + NODE_W + 8} y={PAD.top + netH + 26} fontSize={11} fill="var(--ink-3)" className="tnum">
