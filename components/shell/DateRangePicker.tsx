  ...
  return (
    <div ref={ref} className={cn("relative", className)}>
      ...
      >
        ...
        <span className="hidden shrink-0 items-center gap-1 rounded bg-surface-3 px-1.5 py-0.5 text-[11.5px] font-semibold text-ink-2 sm:flex">
        ...
        <div role="dialog" aria-label="Period and comparison" className="anim-scale-in absolute top-full left-0 z-50 mt-1.5 max-h-[80vh] w-full origin-top-left overflow-y-auto rounded-lg border border-line bg-surface shadow-pop sm:w-[560px] sm:max-w-[calc(100vw-5rem)]">
          <div className="grid grid-cols-1 divide-line sm:grid-cols-2 sm:divide-x">
            ...
            <div className="p-2">
              ...
              <div className="mt-1.5 border-t border-line pt-2">
                ...
                <div className="flex items-end gap-2 px-2">
                  ...
                  />
                  <span className="pb-2 text-[11.5px] text-ink-4">to</span>
                  <MonthSelect
                    label="To"
                    value={range.to}
                    min={range.from}
                ...
                <p className="px-2 pt-2 text-[11.5px] text-ink-4">
            ...
            <div className="border-t border-line p-2 sm:border-t-0">
              ...
              <div className="mt-1.5 border-t border-line pt-2">
                ...
                <p className="px-2 pt-2 text-[11.5px] leading-relaxed text-ink-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-line bg-surface-2 px-3 py-2.5 sm:flex-nowrap">
            ...
            <button
              ...
              className="rounded-md bg-brand px-3 py-1.5 text-[12.5px] font-medium text-white transition-colors hover:bg-brand-hover"
            >
              Done
            </button>
          </div>
  ...
  return (
    <label className="block min-w-0 flex-1">
      ...
      <select
        ...
        className="h-8 w-full rounded-md border border-line bg-surface px-2 text-[12.5px] text-ink focus:border-brand focus:outline-none"
      >
        {months.map((m) => (
          <option
            key={m.key}
