...
const BASE =
  ...
  "transition-[background-color,border-color,color,box-shadow,transform] duration-[var(--dur-press)] ease-[var(--ease-out)] " +
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "transition-[background-color,color,border-color,transform] duration-[var(--dur-press)] ease-[var(--ease-out)]",
