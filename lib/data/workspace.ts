...
export type FieldSource = "shopify" | "amazon" | "meta" | "google" | "cost-model" | "manual" | "derived";
    ...
    sections: [
      {
        ...
        fields: [
          { id: "product_cogs", label: "Product COGS", seed: 0, unit: "inr", source: "cost-model", bind: { kind: "perOrder", driver: "cogsPerOrder" }, help: "Unit cost × units shipped, from the local cost model." },
          { id: "import_clearing", label: "Import clearing", seed: 34_600, unit: "inr", source: "cost-model", bind: null },
          { id: "duty_drawback", label: "Duty drawback credit", seed: -12_400, unit: "inr", source: "cost-model", bind: null },
          { id: "write_off", label: "Inventory write-off", seed: 28_900, unit: "inr", source: "cost-model", bind: null },
    ...
    sections: [
      {
        ...
        fields: [
          {
            id: "shipping_charges", label: "Shipping charges", seed: 0, unit: "inr", source: "cost-model",
          ...
          { id: "packaging_charges", label: "Packaging charges", seed: 0, unit: "inr", source: "cost-model", bind: { kind: "perOrder", driver: "packagingPerOrder" } },
          { id: "reverse_logistics", label: "Reverse logistics", seed: 118_400, unit: "inr", source: "cost-model", bind: null, help: "Cost of collecting and restocking returns." },
          { id: "cod_handling", label: "COD handling", seed: 62_900, unit: "inr", source: "cost-model", bind: null },
          { id: "shipment_insurance", label: "Shipment insurance", seed: 19_300, unit: "inr", source: "cost-model", bind: null },
...
export const SOURCE_META: Record<FieldSource, { label: string; short: string }> = {
  ...
  "cost-model": { label: "Calculated from the local cost model", short: "Cost model" },
  manual: { label: "Entered manually", short: "Manual" },
  derived: { label: "Calculated by Nira", short: "Derived" },
};
