...
export const STAGES: GuideStage[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "t-cost-model", label: "Replace the local cost model", detail: "Move seeded product costs into a versioned API or database when live integrations are ready. Keep the calculation contract stable.", effort: "M" },
    ],
  },
  {
    id: "stage-ship",
...
export const ENV_VARS: EnvVar[] = [
  { key: "DATABASE_URL", purpose: "Postgres connection string for the app database.", example: "postgresql://user:pass@host:5432/nira", required: true, group: "Database" },
