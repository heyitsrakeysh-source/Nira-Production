    ...
    <PageShell>
      ...
      <div className="mt-6 grid grid-cols-1 gap-3 xl:grid-cols-[minmax(0,1fr)_336px]">
        ...
        <div className="print-sheet overflow-hidden rounded-lg border border-line bg-surface shadow-sm">
          <div className="border-b border-line px-8 py-6">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-2.5">
                <Logo size={26} />
                <span className="text-[15px] font-bold tracking-[-0.03em] text-ink">Nira</span>
              </div>
              <p className="text-[11.5px] text-ink-4">Generated 25 Aug 2026</p>
            </div>

            <h2 className="mt-6 text-[26px] font-bold tracking-[-0.025em] text-ink">
              {brand.name} Monthly Profitability Report
            </h2>
            <p className="mt-1 text-[13.5px] font-semibold text-brand-ink">{current.label}</p>

            <p className="mt-5 max-w-2xl text-[17px] leading-snug font-bold tracking-[-0.02em] text-ink">
          ...
          {/* trend */}
          <div className="border-b border-line px-8 py-6">
            <h3 className="text-[13.5px] font-semibold text-ink">Net profit and margin over the last twelve months</h3>
            <div className="mt-3">
          ...
          <div className="grid grid-cols-1 divide-line lg:grid-cols-2 lg:divide-x">
            <div className="px-8 py-6">
              <h3 className="text-[13.5px] font-semibold text-ink">P&amp;L summary for {current.label}</h3>
              <table className="mt-3 w-full border-collapse text-[12.5px]">
                <thead>
                  <tr className="border-b border-line">
                    <th scope="col" className="pb-2 text-left text-[11.5px] font-semibold tracking-wide text-ink-3 ">Line item</th>
                    <th scope="col" className="pb-2 text-right text-[11.5px] font-semibold tracking-wide text-ink-3 ">Amount</th>
                    <th scope="col" className="pb-2 text-right text-[11.5px] font-semibold tracking-wide text-ink-3 ">% rev</th>
                    <th scope="col" className="pb-2 text-right text-[11.5px] font-semibold tracking-wide text-ink-3 ">MoM</th>
                  </tr>
                </thead>
                <tbody>
                  {[
            ...
            <div className="px-8 py-6">
              <h3 className="text-[13.5px] font-semibold text-ink">Three things to fix</h3>
              <ol className="mt-3 space-y-3.5">
                {fixes.map((f) => (
                  <li key={f.n} className="flex gap-3">
                    <span className="grid size-6 shrink-0 place-items-center rounded-full bg-brand-soft text-[11.5px] font-bold text-brand-ink">
                      {f.n}
                    </span>
          ...
          <footer className="flex items-center justify-between border-t border-line px-8 py-4 text-[11.5px] text-ink-4">
            <span>Confidential. Prepared for the internal use of {brand.name}.</span>
            <span>Nira · generated from the live model</span>
          </footer>
        </div>
            ...
            <div className="mt-4 overflow-hidden rounded-xl border border-line bg-surface-2">
              <div className="flex items-center justify-between border-b border-line bg-surface px-4 py-3">
                <div className="flex items-center gap-2">
                  <Logo size={20} />
                  <span className="text-[13.5px] font-bold tracking-[-0.03em] text-ink">Nira</span>
                </div>
                <span className="relative">
                  <Bell size={15} className="text-ink-3" />
                  <span className="absolute -top-1 -right-1 grid size-[13px] place-items-center rounded-full bg-critical text-[11.5px] font-bold text-white">
                    3
                  </span>
                </span>
              </div>
              ...
              <div className="p-4">
                <p className="text-[11.5px] text-ink-4">Yesterday · 24 Aug</p>
                <p className="mt-0.5 text-[13.5px] font-semibold text-ink">Yesterday&apos;s contribution</p>
                  ...
                  {[
                    ...
                    <li key={r.k} className="flex items-center gap-3 py-2.5">
                      <span className="min-w-0 flex-1">
                        ...
                        <span className="tnum block text-[13.5px] font-semibold text-ink">{r.v}</span>
                      </span>
              ...
              {[
                ...
                <li key={r.id} className="flex items-center gap-3 py-3">
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="block text-[11.5px] text-ink-4">{r.note}</span>
                  </span>
                  <Toggle
