          ...
          {[
            ...
            <div key={s.label} className="rounded-lg border border-line bg-surface-2 p-3">
              ...
              <div className="mt-1.5 flex flex-wrap items-baseline gap-1.5">
                <span className="figure-lg text-[17px] text-ink">{s.fmt(s.value)}</span>
...
function FlowCard({
  ...
  return (
    <div
      className={cn(
        "flex flex-col rounded-lg border bg-surface p-4 shadow-xs transition-[box-shadow,transform] duration-200 can-hover:-translate-y-px hover:shadow-md",
    ...
    >
      ...
      <div className="mt-3 flex flex-wrap items-baseline gap-2">
        <span
          className={cn(
            "figure-lg text-[26px] leading-none",
  ...
  return (
    <li className="rounded-lg border border-line bg-surface-2 p-3">
      <div className="flex items-start gap-2.5">
        <span className="grid size-6 shrink-0 place-items-center rounded-md bg-surface text-[11.5px] font-bold text-ink-3 ring-1 ring-line">
          {rank}
        </span>
        <span
          className={cn(
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-baseline justify-between gap-x-2">
            <span className="text-[13.5px] font-semibold text-ink">{driver.label}</span>
            <span className={cn("tnum text-[13.5px] font-bold", bad ? "text-critical-ink" : "text-good-ink")}>
          ...
          {action ? (
            <div className="mt-2 flex items-center justify-between gap-2">
              <p className="text-[11.5px] leading-snug text-ink-4">{action.body}</p>
              <Link
                href={action.href}
                className="shrink-0 rounded-md border border-line bg-surface px-2 py-1 text-[11.5px] font-medium text-brand-ink transition-colors hover:border-brand"
              >
                {action.label}
              </Link>
            </div>
